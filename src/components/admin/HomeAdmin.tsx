...
const GROUPS: GroupDef[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "hero.slide2.eyebrow", label: "Slide 2 — Eyebrow", defaultValue: "Expertise" },
      { key: "hero.slide2.title", label: "Slide 2 — Titre", defaultValue: "Droit des" },
      { key: "hero.slide2.accent", label: "Slide 2 — Accent doré", defaultValue: "affaires" , clearable: true },
      { key: "hero.slide3.eyebrow", label: "Slide 3 — Eyebrow", defaultValue: "Protection" },
      { key: "hero.slide3.title", label: "Slide 3 — Titre", defaultValue: "Droit du" },
      { key: "hero.slide3.accent", label: "Slide 3 — Accent doré", defaultValue: "travail" , clearable: true },
      { key: "hero.slide4.eyebrow", label: "Slide 4 — Eyebrow", defaultValue: "Assistance" },
      { key: "hero.slide4.title", label: "Slide 4 — Titre", defaultValue: "Dommage" },
      { key: "hero.slide4.accent", label: "Slide 4 — Accent doré", defaultValue: "corporel" , clearable: true },
      { key: "hero.slide5.eyebrow", label: "Slide 5 — Eyebrow", defaultValue: "Accompagnement" },
      { key: "hero.slide5.title", label: "Slide 5 — Titre", defaultValue: "Droit de la" },
      { key: "hero.slide5.accent", label: "Slide 5 — Accent doré", defaultValue: "famille" , clearable: true },
      { key: "hero.slide6.eyebrow", label: "Slide 6 — Eyebrow", defaultValue: "Défense" },
      { key: "hero.slide6.title", label: "Slide 6 — Titre", defaultValue: "Droit" },
      { key: "hero.slide6.accent", label: "Slide 6 — Accent doré", defaultValue: "administratif" , clearable: true },
      { key: "hero.slide7.eyebrow", label: "Slide 7 — Eyebrow", defaultValue: "Protection" },
      { key: "hero.slide7.title", label: "Slide 7 — Titre", defaultValue: "Droit des" },
      { key: "hero.slide7.accent", label: "Slide 7 — Accent doré", defaultValue: "étrangers" , clearable: true },
      { key: "hero.slide8.eyebrow", label: "Slide 8 — Eyebrow", defaultValue: "Investissement" },
      { key: "hero.slide8.title", label: "Slide 8 — Titre", defaultValue: "Droit" },
      { key: "hero.slide8.accent", label: "Slide 8 — Accent doré", defaultValue: "immobilier" , clearable: true },
      { key: "hero.slide9.eyebrow", label: "Slide 9 — Eyebrow", defaultValue: "Afrique" },
      { key: "hero.slide9.title", label: "Slide 9 — Titre", defaultValue: "Droit" },
      { key: "hero.slide9.accent", label: "Slide 9 — Accent doré", defaultValue: "OHADA" , clearable: true },
    ],
  },
  {
