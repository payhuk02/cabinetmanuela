...
const GROUPS: GroupDef[] = [
  {
    ...
    keys: [
      { key: "seo.home.title", label: "Titre (≤ 60 caractères)", defaultValue: "Avocat Paris — Cabinet ROGER VANGAH | Affaires & OHADA" },
      ...
      { key: "seo.home.jsonld.name", label: "Nom du cabinet (données structurées)", defaultValue: "Cabinet ROGER VANGAH" },
  ...
  },
  {
    label: "Page Cabinet",
    keys: [
      { key: "seo.cabinet.title", label: "Titre", defaultValue: "Le Cabinet ROGER VANGAH — Avocats à Paris & en Afrique" },
      { key: "seo.cabinet.description", label: "Description", multiline: true, defaultValue: "Découvrez le Cabinet ROGER VANGAH : valeurs, méthodologie et expertise juridique au service des entreprises et particuliers, France et Afrique." },
  ...
  },
  {
    ...
    keys: [
      { key: "seo.expertises.title", label: "Titre", defaultValue: "Expertises juridiques — Cabinet ROGER VANGAH, Paris" },
  ...
  },
  {
    label: "Page Équipe",
    keys: [
      { key: "seo.team.title", label: "Titre", defaultValue: "Notre équipe d'avocats — Cabinet ROGER VANGAH Paris" },
      { key: "seo.team.description", label: "Description", multiline: true, defaultValue: "Maître ROGER VANGAH et ses avocats partenaires vous accompagnent à Paris et en Afrique avec rigueur, confidentialité et excellence juridique." },
  ...
  },
  {
    ...
    keys: [
      { key: "seo.news.title", label: "Titre", defaultValue: "Actualités juridiques & analyses — ROGER VANGAH Avocats" },
      { key: "seo.news.description", label: "Description", multiline: true, defaultValue: "Articles, analyses et actualités du Cabinet ROGER VANGAH : droit des affaires, OHADA, contentieux, fiscalité et droit international." },
  ...
  },
  {
    label: "Page Contact",
    keys: [
      { key: "seo.contact.title", label: "Titre", defaultValue: "Contact — Cabinet d'avocats ROGER VANGAH à Paris" },
      { key: "seo.contact.description", label: "Description", multiline: true, defaultValue: "Contactez le Cabinet ROGER VANGAH, avocat au Barreau de Paris. Prise de rendez-vous, téléphone et adresse — 3 av. des Ternes, 75017 Paris." },
