        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative aspect-[4/5] md:aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden shadow-elegant group">
              <img 
                src={(founderImage as any)?.src || founderImage} 
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            <p className="eyebrow text-accent mb-6">Le mot de l'avocate</p>
            <blockquote className="font-serif text-3xl md:text-4xl lg:text-5xl italic leading-[1.3] text-primary">
              "La justice n'est pas une simple procédure, c'est un droit fondamental. Notre mission est de vous accompagner avec humanité et détermination pour le faire valoir."
            </blockquote>
            <div className="mt-12 flex items-center gap-6">
              <div className="h-px w-16 bg-gradient-to-r from-accent to-transparent" />
              <div>
                <p className="font-bold tracking-widest uppercase text-sm text-foreground">Maître Manuela DIABATE</p>
                <p className="text-muted-foreground text-sm mt-1">Avocate au Barreau de Paris</p>
              </div>
            </div>
          </motion.div>
        </div>
